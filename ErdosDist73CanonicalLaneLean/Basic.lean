/-!
# erdos-dist-73 Lean migration boundary
...
`erdos_dist_73/SourcePackage.lean`.
...
def sourceRepository : String := "erdos-dist-73"
def sourceUrl : String := "https://github.com/HautevilleHouse/erdos-dist-73"
def sourceDescription : String := "Canonical-lane closure package for the Erdős Distinct Distances (n=73): admissible-class formulation, projection gates, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["erdos-dist-73", "canonical-lane", "admissible-class", "mathematical-proof", "reproducibility"]
