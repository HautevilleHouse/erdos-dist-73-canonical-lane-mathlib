# Erdős Distinct Distances (n=73) — Canonical Lane Mathlib

Mathlib-backed Canonical Lane formalization package for the Erdős Distinct Distances (n=73).

## Clean-clone replay

```bash
git clone https://github.com/HautevilleHouse/erdos-dist-73-mathlib.git
cd erdos-dist-73-mathlib
lake exe
lake build
```
